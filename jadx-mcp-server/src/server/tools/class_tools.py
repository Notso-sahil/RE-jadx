...
async def get_all_classes(offset: int = 0, count: int = 0) -> dict:
    ...
    return await PaginationUtils.get_paginated_data(
        ...
        fetch_function=get_from_jadx_cached
    )
...
async def get_methods_of_class(class_name: str) -> dict:
    ...
    """
    return await get_from_jadx_cached("methods-of-class", {"class_name": class_name})
...
async def get_fields_of_class(class_name: str) -> dict:
    ...
    """
    return await get_from_jadx_cached("fields-of-class", {"class_name": class_name})
...
async def get_smali_of_class(class_name: str) -> dict:
    ...
    """
    return await get_from_jadx_cached("smali-of-class", {"class_name": class_name})
...
async def get_main_application_classes_names() -> dict:
    ...
    """
    return await get_from_jadx_cached("main-application-classes-names")
...
async def get_main_activity_class() -> dict:
    ...
    """
    return await get_from_jadx_cached("main-activity")
...
async def get_package_tree() -> dict:
    ...
    """
    return await get_from_jadx_cached("package-tree")
